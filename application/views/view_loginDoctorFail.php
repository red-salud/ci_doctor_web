...
<div id="pagewidth">
	...
	<div id="wrapper" class="clearfix" style="padding-top:6%;">
			<div id="maincol">
				...
				<p style="text-align:left; font-size: 12px; color:#C90000; background-color: #E2F4FF; width: 54%; padding: 1% 1% 1% 1%;">El email o contraseña son incorrectos; por favor vuelva a ingresarlos.</p>  
	            <fieldset class="loginFieldset">	
	                 ...
	                 <div id="rightCol">
	                 	...
	                 	<p style="text-align:right; font-size: 12px;">¿No recuerda su contraseña?. <a href="#">Recupérela aquí</a></p>
