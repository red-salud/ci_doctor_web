...
function addRow(frm) {
	if(countRow <= 3) //maximo de inputs permitidos						
	{
		...
		var row = '<p id="rowNum'+rowNum+'"><input type="hidden" name="idMedi'+rowNum+'" value="'+frm.add_name.value+'"> <input style= "padding: 8px 6px; height: 22px; width: 24%;" name="[sin_trat]" value="'+valor+'" readonly> <input style= "padding: 8px 6px; height: 22px; width: 50%;" name="[sin_dosis]" value="'+frm.add_name.value+'" readonly> <input type="button" class="boton" value="Eliminar" onclick="removeRow('+rowNum+');"></p>';
	...
	<div id="wrapper" style="width:auto;" class="clearfix">
			<div id="maincol" style="width:60%; padding-left:20%;">
				...
				<div id="tabs" style="width:auto;">
					...
					<div id="grupo">
						<form id="form1" name="form1" class="pure-form" role="form" action="guardaSiniestroP2" method="post">
						...
						<form id="form2" name="form2" role="form" action="guardaSiniestroP2" method="post">						    
						    <fieldset>
						    ...
						    <fieldset>						        
						        ...
						        <input name="sin_diagnosticoSec" id="sin_diagnosticoSec" style="padding: 8px 6px; height: 22px; width: 95%;" /><br>
						    	...
						    	<table border="0" style="width:100%; border-spacing:3px;">
						    		<tr>
						    			<th style='width:20em; text-align:center;'>MEDICINA</th>
						    			<th style='width:35.5em; text-align:center;'>DOSIS</th>
						    		</tr>
						    		<tr>
						    			<td>
								        <textarea name="sin_tratamientoSec" id="sin_tratamientoSec" style="width:90%; resize:none; height: 5em;"></textarea>  
								    	</td>
								    	<td>
								        <textarea name="sin_dosisSecundaria" id="sin_dosisSecundaria" style="width:90%; resize:none; height: 5em;"></textarea>
								    	</td>
							    	</tr>
						        </table>
