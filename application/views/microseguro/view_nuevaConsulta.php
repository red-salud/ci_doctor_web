...
<div id="pagewidth" >
	...
	<div id="wrapper" class="clearfix">
			<div id="maincol">
                ...
                <form action="resultNuevoBusca" method="post">
            <fieldset>
                <legend>Nueva Consulta</legend>

                Ingrese apellido de paciente a generar la consulta: <br><br>  <input type="text" name="nombre">  <input type="submit" name="submit" value="Buscar"/>
