...
$string = "ORDEN DE MEDICAMENTOS ADICIONALES";
...
?>
	...
	<html>
		...
		<tr style="horizontal-align: center;">
			...
			<td style="text-align:right; width:37%; horizontal-align: left;"><button type="submit"><?php echo "Orden Atencion Nº: "?></button></td>
			<td style="text-align:right; width:13%; font-size:12px; background-color:#000000; color:#ffffff;"><h4><button type="submit"><?php echo $sin_numOA?></button></h4></td>
		</tr>
		<tr>
			...
			if ($tratAdd!=0){?>	
				...
				<table style="width:100%; border-spacing:3px;" border="1" >
					...
					<tr>
		    			...
		    			<th style="text-align:center; height:17px;"><h4>Cobertura</h4></th> 

		  			</tr>

		  			<?php foreach ($tratAdd as $u): ?>
						<tr>
							...
							<td style="height:17px;">
								<?php 
									if($u['trat_tipo']==24)
										{echo 'Cubierto';}
									elseif(($u['trat_tipo']==4) or ($u['trat_tipo']==3))
										{echo 'No cubierto';}
								?> </td>
						</tr>											 
					<?php endforeach; ?>
