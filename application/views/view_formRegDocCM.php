	...
	<div id="wrapper" class="clearfix">
			<div id="maincol">
				...
				<div id="tabs">
					  ...
					  <div id="fragment-1">
					   <form name= "update" action="updateDoctorCM" method="post">
				            <fieldset>
				                <legend>FORMULARIO DE REGISTRO DE CENTRO MEDICO / LABORATORIOS Y FARMACIAS </legend>
				                <div>
				                ...
				                <div>Nombre de Centro Medico / Laboratorio / Farmacia / otros:<br>
				                    <input type="text" name="nombreCm" value="<?php echo $nomCm_Doc?>"/>
				                    <!-- <input type="hidden" name="nombre" value="<?php echo $nom_Doc?>"/> -->
				                </div>
				                <div>Nombre de Contacto:<br>
				                ...
				                <div>Departamento:<br>
				                    <input type="text" name="dep" value="<?php echo $dep_Doc?>"/>
				                </div>				                				                
				                <div>Teléfono:<br>
