			...
			<div id="maincol" style="width:60%; padding-left:20%;">
				...
				<div id="tabs" style="width:auto;">
					  ...
					  <!-- <input type="button" value="Nuevo" onclick="window.location='http://www.google.com';" /> -->
						...
						<div id="grupo">
						<h4>El registro de Siniestro se cargó correctamente con la siguiente información:</h4>
						...
						<h4>Fecha de Atención: <?php echo $sin_fecha?></h4>
						<h4>Lugar de Atención: <?php echo $nomEst_Prov?></h4>
						<h4>Especialidad: <?php echo $sin_especialidad?></h4>
						<br>

						<div id="grupo"> <br>
							<form class="pure-form" action="imprimeOA" style="float:left;" method="post" target="_blank">
								...
								<input type="hidden" name="sin_especialidad" value="<?php echo $sin_especialidad?>">
								<input type="hidden" name="sin_id" value="<?php echo $sin_id?>">
								<button type="submit" class="pure-button pure-button-primary">Imprimir Orden de Atención</button> <br><br>
							</form>

							<form class="pure-form" action="imprimeTratamiento" style="float:left;" method="post" target="_blank">
								<input type="hidden" name="sin_numOA" value="<?php echo $sin_numOA?>">
								<input type="hidden" name="numDoc" value="<?php echo $numDoc?>">
								<input type="hidden" name="nomEst_Prov" value="<?php echo $nomEst_Prov?>">
								<input type="hidden" name="nombrePac" value="<?php echo $nombrePac?>">
							...
							<form class="pure-form" action="imprimeExamen" style="float:left;" method="post" target="_blank">
								<input type="hidden" name="sin_numOA" value="<?php echo $sin_numOA?>">
								<input type="hidden" name="numDoc" value="<?php echo $numDoc?>">
								<input type="hidden" name="nomEst_Prov" value="<?php echo $nomEst_Prov?>">
								<input type="hidden" name="nombrePac" value="<?php echo $nombrePac?>">
								<input type="hidden" name="sin_id" value="<?php echo $sin_id?>">
								<button type="submit" class="pure-button pure-button-primary">Imprimir Orden de Exámenes</button> <br><br>
							</form>
